...
import { RiMenu3Fill, RiMoonFill, RiSunFill } from "react-icons/ri";
...
export default function Header() {
  ...
  return (
    <header className="bg-background relative top-0 z-20 transition-colors">
      <nav className="mx-auto flex max-w-4xl items-center justify-between gap-3 px-4 py-3 md:px-6">
        ...
        <ul className="hidden items-center gap-1 md:flex">
          {headerLinks.map((link) => (
            <li key={link.id}>
              <NavLink
                to={link.href}
                className="hover:text-primary bg-tertiary text-primary rounded-lg px-4 py-2 transition-colors"
              >
                {link.label}
              </NavLink>
            </li>
        ...
        <div className="relative flex h-8 w-8 items-center justify-center md:hidden">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon">
                <RiMenu3Fill className="block h-5 w-5 transition-all" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              {headerLinks.map((link) => (
