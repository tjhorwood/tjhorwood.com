...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-4xl text-center md:mb-0 scroll-mt-[100rem]"
    >
      <div className="flex items-center justify-center">
        <div className="flex flex-1 flex-col items-center justify-center gap-8 md:flex-row md:items-start sm:gap-6 md:gap-8">
          <motion.div
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="relative m-2 h-40 w-40 sm:h-44 sm:w-44 md:h-48 md:w-48 lg:h-56 lg:w-56 rotate-[4deg] overflow-hidden rounded-[25%] shadow-xl object-cover"
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, scale: 0 }}
            ...
            className="flex flex-col items-center space-y-4 md:items-start md:space-y-2 md:my-auto"
          >
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-800 dark:bg-white/80 text-white dark:text-gray-950 px-7 py-3 flex items-center gap-2 rounded-full outline-none transition hover:scale-105 w-full md:w-auto"
          onClick={() => {
        ...
        <a
          className="group bg-gray-200 hover:bg-gray-300 dark:bg-white/10 dark:hover:bg-white/20 px-7 py-3 flex items-center gap-2 rounded-full outline-none transition hover:scale-105 cursor-pointer w-full md:w-auto"
          href="/resume.pdf"
          download
        >
          Download Resume{" "}
