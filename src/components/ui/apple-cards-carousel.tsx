    ...
    >
      <div className='relative w-full'>
        ...
        <div className='mr-8 flex justify-end gap-2'>
          <button
            className='relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-tertiary disabled:opacity-50'
            onClick={scrollLeft}
  ...
  return (
    <>
        ...
        {open && (
          <div className='fixed inset-0 z-50 h-screen overflow-auto'>
            ...
            <motion.div
              ...
              className='relative z-[60] mx-auto my-10 h-fit max-w-5xl rounded-2xl bg-white p-4 font-sans dark:bg-neutral-900 md:p-10'
            >
              <button
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className='relative z-10 flex h-96 w-64 flex-col items-start justify-start overflow-hidden rounded-2xl bg-tertiary dark:bg-neutral-900 md:h-[30rem] md:w-96'
      >
