            ...
            >
              <div className='flex w-full flex-col gap-6 rounded-xl bg-tertiary lg:w-5/6'>
                <div className='flex h-full flex-col space-y-6 px-5 pb-7 pt-4 sm:max-w-[50%] sm:pl-8 sm:pr-2 sm:pt-8 md:max-w-[55%] lg:max-w-[60%]'>
                  ...
                  >
                    <button className='flex w-full items-center justify-center rounded-lg bg-gray-900 px-8 py-2 text-lg text-white outline-none underline-none transition hover:scale-105 dark:bg-white/80 dark:text-gray-900'>
                      Visit site
                    </button>
                  </Link>
                </div>
