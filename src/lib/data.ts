...
export const workplacesData = [
  {
    ...
    description: [
      {
        content: "Lead SRE practices for Citi's Consumer Sector, focusing on stability, efficiency, and effectiveness of critical applications"
      },
      {
        content: 'Implement and manage SLOs, error budgets, and actionable alerts'
      },
      {
        content: 'Drive resiliency engineering using tools like Chaos Monkey and Gremlin'
      },
      {
        content: 'Conduct blameless postmortems and develop executive briefings on major incidents'
      },
      {
        content: 'Spearhead toil reduction and automation initiatives'
      },
      {
        content: 'Utilize cloud technologies including Docker, Kubernetes, and OpenShift'
      },
      {
        content: 'Apply GenAI, AI, and ML concepts to improve system performance and predictive analytics'
      },
      {
        content: 'Develop solutions using Java, Go, Python, and shell scripting'
      },
      {
        content: 'Manage SQL/NoSQL databases and work with microservices architecture'
      },
      {
